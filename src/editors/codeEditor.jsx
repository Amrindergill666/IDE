...
function CodeEditor(props) {
  ...
  let [copyCode,setCopyCode]= useState(template.c);
  ...
  useEffect(() => {
    ...
    if (onFetchTheme !== prevThemeRef.current)
      handleThemeChange();
  ...
  const handleLangChange2 = () => {
    ...
    if(onFetchLanguage=="c")
      setValue(cValue);
    else if(onFetchLanguage=="cpp")
      setValue(cppValue);
    else if(onFetchLanguage=="java")
      setValue(javaValue);
    else if(onFetchLanguage=="py")
      setValue(pythonValue);
  };
  const handleTempChange = () => {
    ...
    if(onFetchLanguage=="c")
      ...
      setValue(template.cpp);
    else if(onFetchLanguage=="java")
      setValue(template.java);
    else if(onFetchLanguage=="py")
      setValue(template.python);
  };
